...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> handleConflictException(ConflictException ex) {
        ...
        body.put("error", "Ocorreu um conflito");
        body.put("message", ex.getMessage());
    ...
    public ResponseEntity<Object> handleBusinessRuleException(BusinessRuleException ex) {
        ...
        body.put("timestamp", LocalDateTime.now());
        body.put("status", HttpStatus.BAD_REQUEST.value());
        body.put("error", "Regra de negócio quebrada");
        body.put("message", ex.getMessage());
        return new ResponseEntity<>(body, HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<Object> handleConstraintViolationException(ConstraintViolationException ex){
        ...
        body.put("error", "Constraint Violation Exception");
        body.put("message", ex.getMessage());
    ...
    public ResponseEntity<Object> handleJWTCreationException(JWTCreationException ex){
        ...
        body.put("timestamp", LocalDateTime.now());
        body.put("status", HttpStatus.BAD_REQUEST.value());
        body.put("error", "Error while generating token");
        body.put("message", ex.getMessage());
        return new ResponseEntity<>(body, HttpStatus.BAD_REQUEST);
    }
